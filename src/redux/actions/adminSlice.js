...
export const fetchCategorias = createAsyncThunk('admin/fetchCategorias', async () => {
    const response = await axios.get('http://www.dcoapi.somee.com/api/ObtenerDatos/MostrarCategorias?idLiga=4');
    return response.data;
});

// Thunk para obtener torneos según la categoría seleccionada
export const fetchTorneos = createAsyncThunk('admin/fetchTorneos', async (idCategoria) => {
...
export const registrarCategoria = createAsyncThunk('admin/registrarCategoria', async (formData) => {
    const body = {
    ...
    const response = await axios.post('https://www.dcoapi.somee.com/api/EnviarDatos/InsertarCategoria_2_3', body);
    return response.data;
});

// Thunk para registrar un torneo
export const registrarTorneo = createAsyncThunk('admin/registrarTorneo', async (formData) => {
    const body = {
        nombreTorneo: formData.nombreTorneo,
        idCategoria: formData.idCategoria,
        numeroEquipos: 80
    };
    const response = await axios.post('https://www.dcoapi.somee.com/api/EnviarDatos/InsertarTorneo_2_0', body);
    return response.data;
});

// Thunk para registrar un equipo
export const registrarEquipo = createAsyncThunk('admin/registrarEquipo', async (formData) => {
    const body = {
        nombre: formData.nombre,
        idTorneo: formData.idTorneo
    };
    const response = await axios.post('https://www.dcoapi.somee.com/api/EnviarDatos/InsertaEquipo_2_5', body);
    return response.data;
});

// Thunk para registrar un jugador
export const registrarJugador = createAsyncThunk('admin/registrarJugador', async (formData) => {
  const body = {
      nombre: formData.nombre,
  ...
  const response = await axios.post('https://www.dcoapi.somee.com/api/EnviarDatos/InsertaJugador_2_6', body);
  return response.data;
});

// Thunk para relacionar jugador con equipo
export const relacionarJugadorEquipo = createAsyncThunk('admin/relacionarJugadorEquipo', async (formData) => {
  const body = {
      idEquipo: formData.idEquipo,
      idJugador: formData.idJugador,
      numeroCamisa: formData.numeroCamisa,
  };
  const response = await axios.post('https://www.dcoapi.somee.com/api/EnviarDatos/RelacionaJugadorEquipo_3_1', body);
  return response.data;
});

// Thunk para registrar un partido
export const registrarPartido  = createAsyncThunk('admin/registrarPartido', async (formData) => {
  ...
  const body = {
   ...
   const response = await axios.post('https://www.dcoapi.somee.com/api/EnviarDatos/InsertarPartido_2_1', body);
  return response.data;
});
